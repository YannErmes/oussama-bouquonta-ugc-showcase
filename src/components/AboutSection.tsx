...
const AboutSection = () => {
  ...
  const skills = [
    {
      icon: Camera,
      title: t('about.skills.content.title'),
      description: t('about.skills.content.desc')
    },
    {
      icon: Edit3,
      title: t('about.skills.editing.title'),
      description: t('about.skills.editing.desc')
    },
    {
      icon: Users,
      title: t('about.skills.engagement.title'),
      description: t('about.skills.engagement.desc')
    },
    {
      icon: TrendingUp,
      title: t('about.skills.growth.title'),
      description: t('about.skills.growth.desc')
    }
  ];
