  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:shadow-hover hover:scale-105 transition-bounce shadow-creative font-semibold",
        social: "bg-neutral-900 text-white hover:bg-neutral-800 hover:shadow-elegant transition-smooth font-medium",
        creative: "creative-gradient text-primary-foreground hover:shadow-hover hover:scale-105 transition-bounce shadow-creative font-semibold",
      },
      size: {
